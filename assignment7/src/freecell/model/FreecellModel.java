...
public class FreecellModel implements FreecellOperations<Card> {
  protected int openNumber;
  protected int cascadeNumber;
  protected int foundationNumber = 4;
   ...
   */
  public FreecellModel(int open, int cascade) {
    if (open < 1) {
   ...
   */
  protected boolean checkCardToOpen(int destPileNumber) {
   ...
   */
  protected boolean checkCardToFoundation(Card card, int destPileNumber) {
  ...
  public static class FreecellBuilder implements FreecellOperationsBuilder<Card> {
    ...
    protected int opens;
    protected final int minCascades = 4;
    protected final int minOpens = 1;
