...
/**
 * This class represents the view when user create a strategy with end date and choose use
 * same weight on every stock, it enables user to type the stock symbols.
 */
public class UseEqualPercentageEnd extends JFrame implements WithTextField {
  ...
  /**
   * The Constructor of UseEqualPercentageEnd, it initializes the UseEqualPercentageEnd view.
   * @param caption caption.
   * @param numberOfStock the number of stocks the user have in the strategy.
   */
  public UseEqualPercentageEnd(String caption, int numberOfStock) {
    super(caption);
    ...
    create.setActionCommand("use equal percentage end create");
    home = new JButton("Home");
    home.setActionCommand("use equal percentage end home");
