 ...
 * different weight on every stock, it enables user to type the stock symbols and its percentage.
 */
public class UseDiffPercentageNoEnd extends JFrame implements WithTextField {
  ...
  /**
   * Constructor of UseDiffPercentageNoEnd, it initializes the UseDiffPercentageNoEnd view.
   * @param caption caption.
   * @param numberOfStock the number of stocks the user have in the strategy.
   */
  public UseDiffPercentageNoEnd(String caption, int numberOfStock) {
    super(caption);
    ...
    create.setActionCommand("use different percentage no end create");
    home = new JButton("Home");
    home.setActionCommand("use different percentage no end home");
