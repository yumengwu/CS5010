...
/**
 * This class represents the view when user choose to create a strategy with an end date and use
 * different weight on every stock in a strategy. It enables use to input the number of stocks in
 * the strategy, the name of the strategy, start date, end date, interval of the strategy and how
 * much money the user invest every period.
 */
public class DiffPercentageEndBasic extends JFrame implements WithTextField {
  ...
  /**
   * Constructor of DiffPercentageEndBasic, it initialize the view including label, text fields,
   * combobox and buttons.
   * @param caption caption.
   */
  public DiffPercentageEndBasic(String caption) {
    super(caption);
    JLabel label;
    ...
    next.setActionCommand("different percentage end basic next");
    home.setActionCommand("different percentage end basic home");
    hint = new JLabel("");
    panel.add(label);
    panel.add(number);
    hintPanel.add(hint);
