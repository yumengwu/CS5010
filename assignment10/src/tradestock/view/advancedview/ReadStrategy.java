...
/**
 * The class represents the view when user read strategy from a file.
 */
public class ReadStrategy extends JFrame implements IAdvancedView {
  private JButton ok;
  private JLabel hint;
  ...
  /**
   * Constructor of ReadStrategy, it initializes the ReadStrategy view.
   * @param caption caption.
   */
  public ReadStrategy(String caption) {
    super(caption);
    fileChooser = new JFileChooser();
    fileChooser.setDialogTitle("Specify a file to open");
    userSelection = fileChooser.showOpenDialog(this);
    ok = new JButton("OK");
    ok.setActionCommand("read strategy home");
