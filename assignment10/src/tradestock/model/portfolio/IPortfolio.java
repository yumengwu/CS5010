...
public interface IPortfolio {
  ...
  /**
   * Add an empty stock to the portfolio.
   * @param stockSymbol given stock
   */
   ...
   */
  void addTransaction(String stockSymbol, LocalDate date, boolean isSell,
                      double number, double cost);
  ...
  /**
   * Return all the stock symbols as a string list.
   * @return string list
   */
